(function ($) {
    ...
    $('.carosuel-slider--v3').slick({
        infinite: true,
        slidesToShow: 3,
        prevArrow: '<button type="button" class="carosuel-cursor carosuel-arrow--prev"><i class="icon icon-arrow-left" style="color: black;"></i></button>',
        nextArrow: '<button type="button" class="carosuel-cursor carosuel-arrow--next"><i class="icon icon-arrow-right" style="color: black;"></i></button>',
        autoplay: true,
        responsive: [{
                breakpoint: 768,
                settings: {
