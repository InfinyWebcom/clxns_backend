...
$(window).on("load", function() {
    ...
    // Chart Data
    var chartData = {
       labels: ["Recoverd", "Pending", "Partial Covered"],
       datasets: [
          {
             label: "My First dataset",
             data: [42, 25, 33],
             backgroundColor: ["#3333cc","#ff6666","#339933"]
          },
         //  {
         //     label: "My Second dataset",
         //     data: [28, 48, 40, 19, 86],
    ...
    // Chart Data
    var chartData = {
       labels: ["Promise to Pay", "Broken Promise to Pay", "Paid", "Field Collection", "Not Reachable"],
       datasets: [
          {
             label: "My First dataset",
             data: [65, 59, 80, 81, 56],
